...
final class Wicked_Folders_Admin {
    ...
    public function admin_enqueue_scripts() {
		...
		wp_localize_script( 'wicked-folders-app', 'wickedFoldersL10n', array(
			...
			'cloneFolderTooltip' 		=> __( 'Creates a copy of the currently selected folder containing the same items. Note: child folders are not cloned.', 'wicked-folders' ),
	...
	public function is_folder_pane_enabled_page() {
		...
		if ( Wicked_Folders::enabled_for( $type ) && ( 'edit.php' == $page || 'upload.php' == $page ) ) {
			return true;
		}
